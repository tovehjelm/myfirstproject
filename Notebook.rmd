...
View(alz_train_p) #View the processed dataset
...
alz_test_scored %>% 
  yardstick::accuracy(diagnosis, class) #Testa accuracy - the number of correctly categorized divided by the total number (in this case 21/33 =0.6363636 )

alz_test_scored %>% 
  yardstick::spec(diagnosis, class)#the once that you get right that are positive 21/25

alz_test_scored %>%
  yardstick::sens(diagnosis, class) #the once that you get right that are negative, 0/8
```
